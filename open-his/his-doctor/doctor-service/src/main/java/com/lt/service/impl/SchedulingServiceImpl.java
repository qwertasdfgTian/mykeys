...
import com.lt.mapper.SchedulingMapper;
import com.lt.domain.Scheduling;
import com.lt.service.SchedulingService;
@Service
                ...
                for (SchedulingFormDto.SchedulingData datump : schedulingFormDto.getData()) {
                    ...
                    for (String s : datump.getSchedulingType()) {
                        if(StringUtils.isNotBlank(s)){
                            scheduling=new Scheduling(userId.intValue(),deptId.intValue(),schedulingDays.get(i),datump.getSubsectionType(),s,DateUtil.date(),schedulingFormDto.getSimpleUser().getUserName());
                            //保存
