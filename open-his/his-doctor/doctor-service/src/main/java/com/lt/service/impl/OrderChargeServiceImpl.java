...
import com.lt.dto.OrderChargeItemDto;
import com.lt.mapper.CareOrderItemMapper;
import com.lt.mapper.OrderChargeItemMapper;
import com.lt.mapper.OrderChargeMapper;
import com.lt.service.OrderChargeService;
...
public class OrderChargeServiceImpl implements OrderChargeService {
    ...
    public void saveOrderAndItems(OrderChargeFromDto orderChargeFromDto) {
        ...
        for (OrderChargeItemDto orderChargeItemDto : orderChargeItemDtoList) {
            ...
            // 设置新的类型让详情页面查不到，生成不了重复的订单
            CareOrderItem careOrderItem=new CareOrderItem();
            careOrderItem.setItemId(orderChargeItem.getItemId());
            careOrderItem.setStatus("4");
